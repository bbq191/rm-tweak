...
# 已经回收进版本控制，独立跑 `packaging/deploy-appload-patch.sh <host>`——**没有接入
# install-all.sh 的自动编排**，字节替换逻辑还没有对真实 appload.so 做过真机验证，见该脚本
# 头注。PR #59 本身已在 2026-09-07 合并进上游 master，但上游至今没有发布带这个修复的新
